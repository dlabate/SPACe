...
data_dir = r"F:\datasets\PennFudanPed"
...
img_path = os.path.join(data_dir, "PNGImages", "FudanPed00001.png")
mask_path = os.path.join(data_dir, "PedMasks", "FudanPed00001_mask.png")
...
print("mask", type(mask), mask.dtype, mask.size())
print(img.size())
# print(mask)
