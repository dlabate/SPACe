...
def main_worker(args):
    ...
    if args.mode == "preview":
        preview_run_loop(args, num_wells=1, sample_wellids=None)
    else:
...
if __name__ == "__main__":
    experiment_path = (r"D:\DATASTORE\IMAGEDATA\Yokogawa_CV8000\Cell Painting\Need to be Analyzed")

    # print(type(experiment_path))
    # WindowsPath
    experiment_folder = [(r"20231212-Screens-Flavonoid-Plate1_20231213_133815")]
