...
def experiment_holder(out_path,out_folder):
    experiment_path = out_path

    # print(type(experiment_path))
    # WindowsPath
    experiment_folder = out_folder
    # WindowsPath
    # return out_path, out_folder
    #
    ...
    for exp_fold in experiment_folder:
        ...
        main_worker(args)
        print(
            f"program finished analyzing experiment {args.experiment} in {(time.time() - start_time) / 3600} hours ... ")
        print("*********************************************************"
              "*********************************************************"
              "*********************************************************"
              "*********************************************************")
...
if __name__ == "__main__":
    experiment_path = ('D:/DATASTORE/IMAGEDATA/Yokogawa_CV8000/Cell Painting/Need to be Analyzed')

    # print(type(experiment_path))
    # WindowsPath
    experiment_folder = ['20231102-Exp40-CP-Multiple-Cell-Lines_20231102_095620']
    #WindowsPath
